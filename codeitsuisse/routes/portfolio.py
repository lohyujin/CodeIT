...
def maximise_1a():
    ...
    logging.info("-------- start function 1a -------")
    ...
    #     if capital > int(stock[2]):
    #         result['portfolio'].append(stock[0])
    #         result['profit'] += int(stock[1])
    #         capital -= int(stock[2])
...
def maximise_1b():
    ...
    logging.info("My result :{}".format(answer[0]))
    logging.info("-------- end function 1b -------")
    return json.dumps(answer[0])
    
@maximise.route('/maximise_1c', methods=['POST'])
def maximise_1c():
    data = request.get_json()
    logging.info("-------- start function 1c -------")
    logging.info("data sent for evaluation {}".format(data))
    ...
    for stock in stocks.tolist()[::-1]:
        ...
        #         capital -= int(stock[2])
                # print('after ' + str(capital))
            counter, capital = divmod(capital, int(stock[2]))
            result['portfolio'] = [stock[0]] * counter
            result['profit'] = int(stock[1]) * counter
    ...
    logging.info("My result :{}".format(answer[0]))
    logging.info("-------- end function 1c -------")
    return json.dumps(answer[0])

@maximise.route('/maximise_2', methods=['POST'])
def maximise_2():
    data = request.get_json()
    logging.info("-------- start function 2 -------")
    logging.info("data sent for evaluation {}".format(data))
